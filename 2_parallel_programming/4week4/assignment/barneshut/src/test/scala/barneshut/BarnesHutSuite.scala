...
import FloatOps._
  ...
  test("Fork with 3 empty quadrants and 1 leaf (nw)") {
    // Body(val mass: Float, val x: Float, val y: Float, val xspeed: Float, val yspeed: Float)
    val b = new Body(123f, 18f, 26f, 0f, 0f)

    // Leaf(centerX: Float, centerY: Float, size: Float, bodies: Seq[Body])
    val nw = Leaf(17.5f, 27.5f, 5f, Seq(b))

    // Empty(centerX: Float, centerY: Float, size: Float)
    val ne = Empty(22.5f, 27.5f, 5f)
    val sw = Empty(17.5f, 32.5f, 5f)
    val se = Empty(22.5f, 32.5f, 5f)

    // Fork(nw: Quad, ne: Quad, sw: Quad, se: Quad)
  ...
  //MK Test
  test("Leaf.insert(b) should return a new Fork if size > minimumSize - new body: (8, 8)") {
    // Body(val mass: Float, val x: Float, val y: Float, val xspeed: Float, val yspeed: Float)
    val b = new Body(10f, 10f, 10f, 0f, 0f)

    // Leaf(centerX: Float, centerY: Float, size: Float, bodies: Seq[Body])
    val leaf = Leaf(5f, 5f, 10f, Seq(b))
    val b2 = new Body(10f, 7f, 7f, 0f, 0f)

    println("LEAF: " + leaf)
    val result = leaf.insert(b2)
    println("\n\nRESULT: " + result)
  ...
  //MK Test
  test("Leaf.insert(b) should return a new Fork if size > minimumSize - new body: (1, 1)") {
    // Body(val mass: Float, val x: Float, val y: Float, val xspeed: Float, val yspeed: Float)
    val b = new Body(10f, 10f, 10f, 0f, 0f)

    // Leaf(centerX: Float, centerY: Float, size: Float, bodies: Seq[Body])
    val leaf = Leaf(5f, 5f, 10f, Seq(b))
    val b2 = new Body(10f, 1f, 1f, 0f, 0f)
